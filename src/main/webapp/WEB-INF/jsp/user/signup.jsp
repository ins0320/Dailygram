...
<body>
	<div id="wrap">
		...
		<section class=" d-flex justify-content-center">
			<content class=" bg-white  border rounded col-4">
				<h1 class="text-center dailygram mt-3">dailygram</h1>
				<h5 class="mt-3 ml-2 text-center">일상을 공유하려면 가입하세요.</h5>
				...
				<div class="d-flex  mt-3">
						...
						<input type="password" id="passwordConfirmInput" class="form-control mt-3" placeholder="비빌번호 확인">
